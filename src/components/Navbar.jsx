...
import { Menu, Home, BookOpen, Film, Tv, Book } from "lucide-react";
    ...
    return (
        <nav className="w-full bg-white dark:bg-neutral-900 shadow-md sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Mobile Menu */}
                {isMenuOpen && (
                  <div className="md:hidden bg-white flex flex-col gap-3 pb-4">
                        <Link
                            to="/anime"
                            className="text-neutral-700 dark:text-neutral-200 flex flex-row items-center gap-2 hover:text-blue-500 transition"
